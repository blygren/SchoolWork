...
const FRIENDS_TEMPLATES = {
    ...
    "Vegetable": ["#FFA500", "#33CC33", "#FFFF00"], // Just 3 colors as requested
    // New friends templates
    "Coffee": ["#6F4E37", "#B87333", "#FFEBCD", "#FFF8DC", "#F5DEB3"],
    "Midnight": ["#2C3E50", "#E74C3C", "#ECF0F1", "#3498DB", "#2980B9"],
    "Retro": ["#FF8E00", "#00A3FF", "#FF5F5F", "#42FF00", "#FFEA00"],
    "Blues": ["#00FFFF", "#40E0D0", "#48D1CC", "#20B2AA", "#00CED1"],
    "Dead": ["#FFD700", "#FFFFFF", "#4169E1", "#C8A2C8", "#B19CD9"],
    "Ninja": ["#000000", "#1C1C1C", "#282828", "#363636", "#424242"],
    "Purple": ["#8A2BE2", "#9400D3", "#9932CC", "#4B0082", "#6A5ACD"],
    "Bee": ["#FFFF00", "#000000"],
    "Hamster": ["#D2B48C", "#F5DEB3", "#FFFFFF", "#FFC0CB", "#A0522D"],
    "King": ["#ADFF2F", "#FFFF00", "#32CD32", "#FFD700", "#228B22"],
    "Me": ["#FF69B4", "#A52A2A", "#32CD32", "#FFA500", "#00FFFF"],
    "Fruit": ["#FFA500", "#FFD700", "#FF8C00", "#FFFF00", "#FFC04D"],
